...
CREATE TABLE `products` (
  ...
  `PRODUCT_CATEGORY` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '產品分類',
  `PRODUCT_IMAGE` json NOT NULL COMMENT '產品圖路徑',
  `PRODUCT_DESCRIPTION` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '產品描述',
  `PRODUCT_PRICE` decimal(10,2) NOT NULL COMMENT '單價',
  `PRODUCT_KCAL` decimal(10,2) DEFAULT NULL COMMENT '熱量 (已加大)',
  `PRODUCT_CARBS` decimal(5,2) DEFAULT NULL COMMENT '碳水化合物',
  `PRODUCT_FAT` decimal(5,2) DEFAULT NULL COMMENT '總脂肪',
  `PRODUCT_FIBER` decimal(5,2) DEFAULT NULL COMMENT '膳食纖維',
  `PRODUCT_PROTEIN` decimal(5,2) DEFAULT NULL COMMENT '蛋白質',
  `PRODUCT_SATURATED_FAT` decimal(5,2) DEFAULT NULL COMMENT '飽和脂肪',
  `PRODUCT_SUGAR` decimal(5,2) DEFAULT NULL COMMENT '糖',
  `PRODUCT_SODIUM` decimal(10,2) DEFAULT NULL COMMENT '鈉 (已加大)',
  `PRODUCT_NET_WEIGHT` decimal(10,2) NOT NULL COMMENT '產品淨重',
  `PRODUCT_INGREDIENTS` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '食材內容',
  `PRODUCT_COOKING_METHOD` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '使用方法',
  `PRODUCT_STORAGE_METHOD` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '保存方式及期限',
  `PRODUCT_REMINDER` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '貼心提醒',
  `PRODUCT_RELEASE` tinyint(1) NOT NULL DEFAULT '0' COMMENT '上下架'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `user_phone` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_address` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
ALTER TABLE `products`
  MODIFY `PRODUCT_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '產品ID', AUTO_INCREMENT=21;
